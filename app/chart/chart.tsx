        ...
        <div className="h-full">
            ...
            <div className="contentWrapper flex flex-col h-full">
                <div className="flex justify-between mb-4 md:mb-8 ">
                    <div className="flex justify-between w-fit h-fit pl-2 ">
                        <h2 className={ `w-40 md:w-60 text-xl text-center font-bold overflow-hidden whitespace-nowrap text-ellipsis border-b-2 border-slate-400 ${title ? "text-slate-600 " : "text-slate-400 "}`}>{title || "無題のマンダラート"}</h2>
